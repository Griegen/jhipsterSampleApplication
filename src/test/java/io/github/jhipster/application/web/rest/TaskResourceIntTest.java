...
public class TaskResourceIntTest {
    ...
    private static final String DEFAULT_FFGHGJ = "AAAAAAAAAA";
    private static final String UPDATED_FFGHGJ = "BBBBBBBBBB";
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getFfghgj()).isEqualTo(DEFAULT_FFGHGJ);
    ...
    public void getAllTasks() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ffghgj").value(hasItem(DEFAULT_FFGHGJ.toString())));
    }
    ...
    public void getTask() throws Exception {
        ...
        restTaskMockMvc.perform(get("/api/tasks/{id}", task.getId()))
            ...
            .andExpect(jsonPath("$.ffghgj").value(DEFAULT_FFGHGJ.toString()));
    }
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getFfghgj()).isEqualTo(UPDATED_FFGHGJ);
